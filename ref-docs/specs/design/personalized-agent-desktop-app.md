...
related: [personalization-strategy, harness-portability-strategy, phase-1-desktop-shell, phase-1-shell-architecture, phase-1-contracts, phase-1-test-plan, phase-1_5-personalization-data-layer, phase-1_5-memory-contracts, phase-1_6-harness-ownership, phase-1_6-harness-contracts, phase-2-personalization-hitl]
...
**Document info** · Written 2026-07-19 · Version v0.10 (Draft) · Audience: the team executing this plan, and the project owner · Status: Review
